...
public class SmsTest(ITestOutputHelper helper)
{
    ...
    public async Task SendSms_ShouldSendCallback()
    {
        ...
        var applicationWithCallback = TestApplicationFactory<Program>.Builder(helper).WithEnvironmentVariable("SMS_DLR", callbackUrl).Build();
